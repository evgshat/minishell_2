...
#    Updated: 2022/03/16 19:32:55 by lcharlet         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
PARSING			=	$(PARSING_DIR)parsing.c\
						$(PARSING_DIR)check_input.c\
						$(PARSING_DIR)check_pipe.c\
						$(PARSING_DIR)check_redirect.c\
						$(PARSING_DIR)look_quotes.c\
						$(PARSING_DIR)ft_isspace.c\
						$(PARSING_DIR)find_redirect.c\
						...
						$(PARSING_DIR)double_r_redirect.c\
						$(PARSING_DIR)double_l_redirect.c\
						$(PARSING_DIR)single_l_redirect.c\
						$(PARSING_DIR)single_r_redirect.c\
						...
						$(PARSING_DIR)before_redirect.c\
						$(PARSING_DIR)after_redirect.c\
						$(PARSING_DIR)af_alnum.c\
						$(PARSING_DIR)af_quotes.c\
						$(PARSING_DIR)af_quote.c\
						$(PARSING_DIR)be_alnum.c\
						$(PARSING_DIR)be_quotes.c\
						$(PARSING_DIR)be_quote.c\
